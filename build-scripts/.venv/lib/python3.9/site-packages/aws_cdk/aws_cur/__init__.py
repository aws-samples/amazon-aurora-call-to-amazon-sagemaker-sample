...
class CfnReportDefinition(
    ...
    def __init__(
        ...
        *,
        ...
        :param refresh_closed_reports: Whether you want Amazon Web Services to update your reports after they have been finalized if AWS detects charges related to previous months. These charges can include refunds, credits, or support fees.
